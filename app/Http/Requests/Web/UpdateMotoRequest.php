...
class UpdateMotoRequest extends FormRequest
{
    ...
    {
        $moto = $this->route('moto');

        return $moto instanceof Moto && ($this->user()?->can('update', $moto) ?? false);
    }
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'plate_number' => ['required', 'string', 'max:20', Rule::unique('motos', 'plate_number')->ignore($moto)],
