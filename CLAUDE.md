...
| Table | Contenu |
|---|---|
| `commissariats`, `mairies` | `id`, `name` (150, unique), `code` (30, unique, nullable), `is_active`, timestamps, `deleted_at`. Adresse, téléphone, région, commune : À VALIDER AVEC LE CLIENT. `mairies` a aussi `card_template` (string, défaut `officiel`, `App\Enums\VgtCardTemplate`, W13) |
