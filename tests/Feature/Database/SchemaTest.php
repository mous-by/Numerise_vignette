...
class SchemaTest extends TestCase
{
    ...
    public function test_the_foundation_has_exactly_the_validated_tables(): void
    {
        ...
        $expected = [
            'activity_logs', 'cache', 'cache_locks', 'commissariats', 'declarations', 'failed_jobs',
            'information_files', 'informations', 'job_batches', 'jobs', 'mairies', 'model_has_permissions',
            'model_has_roles', 'motos', 'motos_retrouvees', 'permissions', 'personal_access_tokens', 'proprietaires',
